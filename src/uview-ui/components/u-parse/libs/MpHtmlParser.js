    ...
    while (1) {
      ...
      if (val[i + 1] == "#") {
        ...
        if (cfg.entities[en] || en == amp)
          val =
            val.substr(0, i) + (cfg.entities[en] || "&") + val.substr(j + 1);
      }
    }
    return val;
  };
...
MpHtmlParser.prototype.setAttr = function () {
  let name = this.attrName.toLowerCase(),
    val = this.attrVal;
        ...
        for (let j = 0, td; (td = trs[i].children[j]); j++) {
          if (td.name == "td" || td.name == "th") {
            ...
            if (td.attrs.colspan) {
              ...
              if (!td.attrs.rowspan)
                cell.attrs.style +=
                  ";grid-row-start:" + row + ";grid-row-end:" + (row + 1);
            ...
            if (td.attrs.rowspan) {
              ...
              if (!td.attrs.colspan)
                cell.attrs.style +=
                  ";grid-column-start:" + col + ";grid-column-end:" + (col + 1);
